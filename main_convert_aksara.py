...
file_list = ["skrip/jtwk_ke_latin_normal.py", "skrip/jtwk_ke_jawa.py", "skrip/jawa_ke_bali.py", "skrip/jawa_ke_kawi.py", "skrip/jawa_ke_jawarepha.py",  "skrip/jawa_ke_jawadhuwung.py"]
