...
def latin_to_jawa(text, line_spacing):
    ...
    hasil = ""
    last_aksara = ""  # Menyimpan aksara terakhir yang ditambahkan
    last_char = ""    # Menyimpan karakter terakhir yang diproses
    is_new_line = True  # Menandai apakah karakter saat ini berada di awal baris baru
